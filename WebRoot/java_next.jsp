...
<body style="background-color:#CCC;">
	...
	<div class="container">
		<div class="col-md-12"
			...
			<div class="col-md-10 col-md-offset-1" id="java_web">
				<div style="margin-top:10px;">
					<table class="table">
						...
						<tbody>
							<%
								...
								int show_page = 0;
								int page_size = 7;
								if (request.getParameter("show_page") != null) {
									show_page = Integer.parseInt(request.getParameter("show_page"));
									if (show_page == 0) {
										response.sendRedirect("java.jsp");
									}
									if (show_page * page_size >= record_count) {
										out.println("<script>alert('当前已经是最后一页');</script>");
										response.setHeader("refresh", "0;URL='java.jsp'");
									}
								}
					...
					<div class="row">
						...
						<ul class="pagination">
							<li><a href="java_next.jsp?show_page=<%=show_page - 1%>">上一页</a></li>
							<%
